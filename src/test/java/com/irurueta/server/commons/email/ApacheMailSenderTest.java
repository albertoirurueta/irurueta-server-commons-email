...
public class ApacheMailSenderTest {
    ...
    public void testGetInstanceAndReset() {
        final ApacheMailSender mailSender = ApacheMailSender.getInstance();
        ...
        final ApacheMailSender mailSender2 = ApacheMailSender.getInstance();
        assertSame(mailSender, mailSender2);

        // reset
        ApacheMailSender.reset();

        final ApacheMailSender mailSender3 = ApacheMailSender.getInstance();
    ...
    public void testSendMessageToMultipleRecipients()
            ...
            NotSupportedException, InterruptedException {
        final ApacheMailSender mailSender =
    ...
    public void testSendHtmlMessageWithEmailAndInlineAttachments()
        ...
        final String html = "<h1>HTML email using Apache Mail</h1>"
    ...
    public void testSendWithCcBccAndNoSubject() throws NotSupportedException {
        ...
        TextEmailMessage message = TextEmailMessage.create(null, text,
                mailSender);
        message.getTo().add("alberto@irurueta.com");
