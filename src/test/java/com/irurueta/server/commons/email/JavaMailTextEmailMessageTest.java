...
public class JavaMailTextEmailMessageTest {

    @Test
    public void testConstructor() throws NotSupportedException {
        // test empty constructor
        JavaMailTextEmailMessage message = new JavaMailTextEmailMessage();
        ...
        message = new JavaMailTextEmailMessage("subject");
        ...
        message = new JavaMailTextEmailMessage("subject", "text");
    ...
    public void testGetSetText() {
        final JavaMailTextEmailMessage message = new JavaMailTextEmailMessage();
