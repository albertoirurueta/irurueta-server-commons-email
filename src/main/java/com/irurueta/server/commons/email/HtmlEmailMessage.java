...
public abstract class HtmlEmailMessage<E> extends EmailMessage<E> {
    ...
    public HtmlEmailMessage() {
        ...
        mEmailAttachments = new ArrayList<EmailAttachment>();
        mInlineAttachments = new ArrayList<InlineAttachment>();
    }
     ...
     */    
    public HtmlEmailMessage(String subject) {
        super(subject);
        mHtmlContent = null;
        mAlternativeText = null;
        mEmailAttachments = new ArrayList<EmailAttachment>();
     ...
     */    
    public HtmlEmailMessage(String subject, String htmlContent) {
        super(subject);
     ...
     */
    public void setInlineAttachments(List<InlineAttachment> inlineAttachments) {
     ...
     */
    public static HtmlEmailMessage create(EmailSender sender) {
     ...
     * @return an HTML email message.
     */    
    protected static HtmlEmailMessage create(EmailProvider provider) {
     ...
     * @return an HTML email message.
     */    
    public static HtmlEmailMessage create(String subject, 
            EmailSender sender) {
     ...
     * @return an HTML email message.
     */    
    protected static HtmlEmailMessage create(String subject, 
     ...
     * @return an HTML email message.
     */
    public static HtmlEmailMessage create(String subject, String htmlContent,
            EmailSender sender) {
