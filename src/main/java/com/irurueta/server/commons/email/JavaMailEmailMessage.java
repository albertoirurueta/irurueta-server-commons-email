...
/**
 * Interface for emails sent using Java Mail provider.
 */
public interface JavaMailEmailMessage {
     ...
     */
    void buildContent(final MimeMessage content) throws EmailException;
}
