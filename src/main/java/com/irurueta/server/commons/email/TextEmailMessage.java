...
public abstract class TextEmailMessage<E> extends EmailMessage<E> {
     ...
     */
    public static TextEmailMessage create(EmailSender sender) {
     ...
     * @return a textual email message.
     */
    protected static TextEmailMessage create(EmailProvider provider) {
     ...
     * @return a textual email message.
     */
    protected static TextEmailMessage create(String subject,
